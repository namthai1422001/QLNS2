            ...
            if (!$(table).hasClass('hasFilters')) {
				...
				.find('input.' + css).bind('keyup search', function(e) {
				    ...
				    if (v.join('') === '') {
				        ...
				        //Begin Customize by Nguyen Phuong Bac
				        var tinhtrangcuacheckall = $(".check-all-input").is(":checked");
				        $t.find("tr td input[type=checkbox]").attr("checked", tinhtrangcuacheckall);
				        //End Customize by Nguyen Phuong Bac
				        ...
				        $t.find('tbody').find('tr:not(.' + c.cssChildRow + ')').each(function() {
				            ...
				            var tinhtrangcuacheckall = $(".check-all-input").is(":checked");
				            if (r == true) {
				                $(this).find("td input[type=checkbox]").attr("checked", tinhtrangcuacheckall);
				            } else {
				    ...
				    if ($("#listEmployee tbody tr td input[type=checkbox]:checked").length == 0) {
				        $("#ctl00_ContentPage_btnSave").slideUp(80);
				    } else {
				        $("#ctl00_ContentPage_btnSave").slideDown(200);
				    }
