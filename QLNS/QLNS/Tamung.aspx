<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Tamung.aspx.cs" Inherits="QLNS.QLNS.Tamung" %>
			...
			<asp:Repeater ID="rpData" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="width: 15px;"> 
                            <a href='<%# String.Format("ViewTamung@{0}",Eval("Matamung")) %>' title="Chi tiết tạm ứng">
