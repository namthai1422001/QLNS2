<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPhucap.aspx.cs" Inherits="QLNS.QLNS.EditPhucap" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Cập nhật phụ cấp</title>
...
<body>
    <form id="form1" runat="server">
        <fieldset style="margin: 10px auto 20px auto; width: 80%;"> 
            ...
            <p>
                <label>Số tiền lớn nhất nhân viên có thể được nhận<span class="isrequire">(*)</span></label>
                <asp:TextBox ID="txtValue" runat="server" CssClass="text-input small-input" MaxLength="12"
