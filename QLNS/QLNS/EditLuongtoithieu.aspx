<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditLuongtoithieu.aspx.cs" Inherits="QLNS.QLNS.EditLuongtoithieu" %>
...
<%--    <script src="../scripts/jquery.ui.core.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#caidat-nav > a").addClass("current").parent().find("ul").css("display", "block").find("#Luongtoithieu-nav").addClass("current");
...
<div class="content-box" style="min-width: 800px;"><!-- Start Content Box -->
    ...
    <div class="content-box-header">
        ...
        <h3>Thay đổi mức lương tối thiểu</h3>
        ...
        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            ...
            <div class="notification information png_bg">
                ...
                <div>
                    ...
                    <span style="color: #AC2C2C;">- <b>Mức lương tối thiểu</b> sẽ được <b>thay đổi ngay sau khi nhấn nút lưu cài đặt</b>.</span>
                ...
                <table>
                    <tr>
                        <td style="width: 230px;" >
                            Số tiền (VNĐ)<span class="isrequire">(*)</span>:
                        </td>
            ...
            <div class="rightcol" style="height: 370px;">
                ...
                <br />
                <asp:RequiredFieldValidator ID="reqMota"
                    runat="server"
