...
namespace QLNS.QLNS
{
    ...
    /// Hành động: Xem (5)
    /// </summary>
    public partial class Khautru : System.Web.UI.Page
    {
        ...
        private void loadData(int Nam, int Thang, string MaNV)
        {
            ...
            else
            {
                ...
                ltrh3.Text = "Chi tiết khấu trừ tháng " + Request.QueryString["m"] + "/" + Request.QueryString["y"]
                                + " của nhân viên "
                                + objNhanvien.HoTen.ToString();
                var lst = (from p in db.PB_KhautruNhanviens
                ...
                DiarySystem(26, 5, MaNV + " tháng " + Thang.ToString() + "/" + Nam.ToString());

                hplAdd.NavigateUrl = string.Format("EditKhautru.aspx?y={0}&m={1}&id={2}&height=270", Nam, Thang, MaNV);
            }
        }
        #endregion
    }
