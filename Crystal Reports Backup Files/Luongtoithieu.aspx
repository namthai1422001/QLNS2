<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Luongtoithieu.aspx.cs" Inherits="QLNS.QLNS.Luongtoithieu" %>
...
<div class="content-box" style="min-width: 755px;"><!-- Start Content Box -->
    ...
    <div class="content-box-header">
        ...
        <h3>Quy định mức lương tối thiểu</h3>
        ...
        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            <p style="padding-left: 10px;"> 
                <asp:Button ID="btnReInstall" runat="server"
                    Text="Thay đổi mức lương tối thiểu" ToolTip="Thay đổi mức lương tối thiểu"
			...
			<div class="maininfor">
                ...
                <asp:Label ID="lblMota" runat="server" ><b>Chưa được cài đặt</b></asp:Label>
            </div>
