<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBacluong.aspx.cs" Inherits="QLNS.QLNS.EditBacluong" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Cập nhật bậc lương</title>
...
<body>
    <form id="form1" runat="server">
        <fieldset style="margin: 10px auto 20px auto; width: 80%;"> 
            <p>
                <label>Ngạch: 
                    <asp:Label ID="lblNgach" runat="server"></asp:Label>
                </label>
            </p>
            <p>
                <label>Tên bậc lương<span class="isrequire">(*)</span></label>
    		...
    		<p>
                <label>Hệ số lương (%)<span class="isrequire">(*)</span></label>
                <asp:TextBox ID="txtValue" runat="server" CssClass="text-input small-input" MaxLength="5" />
                ...
                <br /><small>Số thập phân (1.50)</small>
