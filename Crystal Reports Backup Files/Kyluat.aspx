<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Kyluat.aspx.cs" Inherits="QLNS.QLNS.Kyluat" %>
...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-header">
        ...
        <h3>Các quyết định kỷ luật nhân viên</h3>
			...
			<asp:Repeater ID="rpData" runat="server">
                ...
                <table>
                    <thead>
                        ...
                        <th> <b>Mã NV</b> </th>
                        <th> <b>Họ tên</b> </th>
                        <th> <b>Ngày xảy ra</b> </th>
                        <th> <b>Tên kỷ luật</th>
                        <th> <b>Hình thức kỷ luật</b> </th>
                        <th> <b>Ngày kỷ luật</b> </th>
                        <th></th>
                    </thead>
                </HeaderTemplate>
                <ItemTemplate>
                    <tr>
                        ...
                        <td> 
                            <%# String.Format("{0:dd/MM/yyyy}", Eval("Ngayxayra")) %>
                        </td>
                        <td> 
                            <%# Eval("Tenkyluat") %>
                        </td>
                        ...
                        <td> 
                            <%# String.Format("{0:dd/MM/yyyy}", Eval("Ngaykyluat")) %>
                        </td>
                        <td style="width: 15px;"> 
                            <a href='<%# String.Format("ViewKyluat@{0}",Eval("Makyluat")) %>' title="Chi tiết kỷ luật">
