<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditPhongbannhanvien.aspx.cs" Inherits="QLNS.QLNS.EditPhongbannhanvien" %>
...
<div class="content-box" style="min-width: 800px;"><!-- Start Content Box -->
    ...
    <div class="content-box-header">
        ...
        <h3>Chuyển nhân viên 
            <asp:Literal ID="lblHoten" runat="server" /> sang phòng ban khác</h3>
    ...
    <div class="content-box-content">
        ...
        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
			...
			<!-- Begin Thông tin -->
			<div class="leftcol">
                <h5>Thông tin phòng hiện tại</h5>
                <table>
                    <tr style="width: 120px;">
                        ...
                        <td>
                            <asp:Label ID="lblTenphong" runat="server" Font-Bold="true" Text="Chưa cài đặt" />
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="rightcol">
                <h5>Thông tin phòng được chuyển đến</h5>
                <table>
                    <tr>
                        ...
                        <td style="width: 172px;">
                            <asp:DropDownList ID="cbPhongmoi" runat="server" Width="180px" />
                        </td>
                        <td>
                            <asp:RegularExpressionValidator ID="regPhongmoi"
                                runat="server"
                                ValidationExpression="[^0]([0-9]*)?"
                                ControlToValidate="cbPhongmoi"
