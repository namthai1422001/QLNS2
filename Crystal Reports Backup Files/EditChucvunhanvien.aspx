<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditChucvunhanvien.aspx.cs" Inherits="QLNS.QLNS.EditChucvunhanvien" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div class="content-box-content">
        ...
        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            <asp:Literal ID="ltrInformation" runat="server" />
			
			<!-- Begin Thông tin -->
			<div class="leftcol">
                <h5>Thông tin chức vụ hiện tại</h5>
                <table>
                    <tr style="width: 120px;" >
                        ...
                        <td>
                            <asp:Label ID="lblTenchucvu" runat="server" Font-Bold="true" Text="Chưa cài đặt" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <table>
                    <tr>
                        ...
                        <td style="width: 172px;">
                            <asp:DropDownList ID="cbChucvumoi" runat="server" Width="180px" />
                        </td>
                        <td>
                            <asp:RegularExpressionValidator ID="regChucvumoi"
                                runat="server"
                                ValidationExpression="[^0]([0-9]*)?"
                                ControlToValidate="cbChucvumoi"
                    ...
                    <asp:Panel ID="pnlNotFirst" runat="server">
                    <tr>
                        <td >
                            Chức vụ người ký: 
                        </td>
            ...
            <p style="text-align: right; margin-right: 10px;">
                ...
                <asp:Button ID="btnSaveFirst" runat="server"
                    Text="Lưu" ToolTip="Lưu"
                    CssClass="button" onclick="btnSaveFirst_Click" />
            </p>
