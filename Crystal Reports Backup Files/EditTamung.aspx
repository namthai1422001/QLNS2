<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="EditTamung.aspx.cs" Inherits="QLNS.QLNS.EditTamung" %>
...
<%--    <script src="../scripts/jquery.ui.core.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var dates = $("#<%= txtNgayky.ClientID %>, #<%= txtNgaytamung.ClientID %>").datepicker({
                showWeek: true,
                showAnim: "slideDown",
                firstDay: 1,
                changeMonth: true,
        ...
        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
			...
			<div style="margin-left: 10px;">
			    ...
			    <p>
			        ...
			        <asp:DropDownList ID="cbNhanviennhantamung" runat="server" Width="180px" />
                    <span>
                        <asp:RegularExpressionValidator ID="regNhanviennhantamung"
                            runat="server"
                            ValidationExpression="[^0]([0-9NV]*)?"
                            ControlToValidate="cbNhanviennhantamung"
                            CssClass="input-notification error errorleft"
                            ErrorMessage="Vui lòng chọn" Display="Dynamic" />
                    </span>
			    </p>
			    ...
			    <p>
			        <span class="spantitle">Ngày tạm ứng<span class="isrequire">(*)</span>: </span>
                    <input id="txtNgaytamung" runat="server" type="text" class="text-input fontbolder" style="width: 80px;" />
			    </p>
			    ...
			    <p>
                    ...
                    <asp:TextBox ID="txtTientamung" runat="server" class="text-input fontbolder" Width="100px" MaxLength="12" Text="0"
                        onkeypress="return onlyNumbers(event)" onkeyup="keyuped(this)" />
                    <span>
                        <asp:RegularExpressionValidator ID="regTientamung"
                            runat="server"
                            ValidationExpression="[0-9,]+"
                            ControlToValidate="txtTientamung"
