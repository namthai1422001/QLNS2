<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Luonglamthem.aspx.cs" Inherits="QLNS.QLNS.Luonglamthem" %>
        ...
        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            <p>
                <asp:HyperLink ID="hplAdd" runat="server"
                    ...
                    class="thickbox"
                    title="Thêm lương làm thêm" >Thêm</asp:HyperLink>
                |
