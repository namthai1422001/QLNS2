<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Danhsachbangchamcong.aspx.cs" Inherits="QLNS.QLNS.Danhsachbangchamcong" %>
...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-header">
        ...
        <h3>Danh sách bảng chấm công</h3>
        ...
        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            <p style="margin-left: 5px;">
                <asp:Button ID="btnAdd" runat="server" CssClass="button"
                    Text="Tạo bảng chấm công" onclick="btnAdd_Click" />
            </p>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <% if (hdIsRoll.Value == "True")
                           { %>
                        <td style="width: 15px;"> 
                            <a href='<%# String.Format("EditBangchamcong@{0}",Eval("Mabangchamcong")) %>' title="Sửa thông tin bảng chấm công">
